...
const AuthContext = createContext<AuthContextType>({
  ...
  signOut: async () => {},
  updateUserProfile: async (_data: Partial<User>) => {},
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const convertFirebaseUser = async (firebaseUser: FirebaseUser): Promise<User> => {
    ...
    if (userDoc.exists()) {
      ...
      // Nettoyer les champs null pour Firestore
      const userDataForFirestore = { ...userData };
      if (userDataForFirestore.email === null) delete userDataForFirestore.email;
      if (userDataForFirestore.photoURL === null) delete userDataForFirestore.photoURL;
